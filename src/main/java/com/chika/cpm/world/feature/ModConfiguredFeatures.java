...
public class ModConfiguredFeatures {
    ...
    //水芭蕉
    public static final RegistryObject<ConfiguredFeature<?, ?>> JAPANESE_SKUNK_CABBAGE_PATCH = CONFIGURED_FEATURES.register("japanese_skunk_cabbage_patch",
            () -> new ConfiguredFeature<>(Feature.FLOWER,
                    new RandomPatchConfiguration(
                            6, 3, 2,
                            PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
                                    new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.JAPANESE_SKUNK_CABBAGE.get()))))));

    //センブリ
    public static final RegistryObject<ConfiguredFeature<?, ?>> JAPANESE_SWERTIA_PATCH = CONFIGURED_FEATURES.register("japanese_swertia_patch",
            () -> new ConfiguredFeature<>(Feature.FLOWER,
                    new RandomPatchConfiguration(
                            6, 3, 2,
                            PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
                                    new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.JAPANESE_SWERTIA.get()))))));
    ...
    //トリカブト
    public static final RegistryObject<ConfiguredFeature<?, ?>> MONKSHOOD_PATCH = CONFIGURED_FEATURES.register("monkshood_patch",
            () -> new ConfiguredFeature<>(Feature.FLOWER,
                    new RandomPatchConfiguration(
                            6, 4, 2,
                            PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
                                    new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.MONKSHOOD.get()))))));
    ...
    //オオバコ
    public static final RegistryObject<ConfiguredFeature<?, ?>> PLANTAIN_PATCH = CONFIGURED_FEATURES.register("plantain_patch",
            () -> new ConfiguredFeature<>(Feature.FLOWER,
                    new RandomPatchConfiguration(
                            6, 4, 2,
                            PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> SPOTTED_BELLFLOWER_PATCH = CONFIGURED_FEATURES.register("spotted_bellflower_patch",
            () -> new ConfiguredFeature<>(Feature.FLOWER,
                    new RandomPatchConfiguration(
                            6, 4, 3,
                            PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
                                    new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.SPOTTED_BELLFLOWER.get()))))));
    ...
    //さぎ草
    public static final RegistryObject<ConfiguredFeature<?, ?>> WHITE_EGRET_FLOWER_PATCH = CONFIGURED_FEATURES.register("white_egret_flower_patch",
            () -> new ConfiguredFeature<>(Feature.FLOWER,
                    new RandomPatchConfiguration(
                            6, 4, 2,
                            PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
                                    new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.WHITE_EGRET_FLOWER.get()))))));
    ...
    //茶の木
    public static final RegistryObject<ConfiguredFeature<?, ?>> TEA_TREE_PATCH = CONFIGURED_FEATURES.register("tea_tree_patch",
            () -> new ConfiguredFeature<>(Feature.FLOWER,
                    new RandomPatchConfiguration(
                            4, 3, 2,
                            PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
                                    new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.TEA_TREE_CROP.get()))))));
    ...
    //Trees
    //椿
    public static final RegistryObject<ConfiguredFeature<?, ?>> CAMELLIA =
            CONFIGURED_FEATURES.register("camellia", () ->
    ...
    //栗
    public static final RegistryObject<ConfiguredFeature<?, ?>> CHESTNUT =
            CONFIGURED_FEATURES.register("chestnut", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
    ...
    //金木犀
    public static final RegistryObject<ConfiguredFeature<?, ?>> FRAGRANT_OLIVE =
            CONFIGURED_FEATURES.register("fragrant_olive", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(Blocks.OAK_LOG),
                            new StraightTrunkPlacer(4, 2, 0),
                            BlockStateProvider.simple(ModBlocks.FRAGRANT_OLIVE_LEAVES.get()),
                            new FancyFoliagePlacer(
                                    UniformInt.of(1, 2),
                                    UniformInt.of(0, 1),
                                    4),
    ...
    //銀杏
    public static final RegistryObject<ConfiguredFeature<?, ?>> GINKGO =
            CONFIGURED_FEATURES.register("ginkgo", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(Blocks.OAK_LOG),
    ...
    //檸檬
    public static final RegistryObject<ConfiguredFeature<?, ?>> LEMON =
    ...
    //紅葉
    public static final RegistryObject<ConfiguredFeature<?, ?>> MAPLE =
            CONFIGURED_FEATURES.register("maple", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(Blocks.OAK_LOG),
    ...
    //桐
    public static final RegistryObject<ConfiguredFeature<?, ?>> PAULOWNIA =
            CONFIGURED_FEATURES.register("paulownia", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(ModBlocks.PAULOWNIA_LOG.get()),
                            new StraightTrunkPlacer(5, 2, 0),
                            BlockStateProvider.simple(ModBlocks.PAULOWNIA_LEAVES.get()),
                            new PineFoliagePlacer(ConstantInt.of(1), ConstantInt.of(2), UniformInt.of(3, 4)),
                            new TwoLayersFeatureSize(2, 0, 2)).build()));


    //白梅
    public static final RegistryObject<ConfiguredFeature<?, ?>> UME =
            CONFIGURED_FEATURES.register("ume", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(ModBlocks.UME_LOG.get()),
                            new ForkingTrunkPlacer(4, 2, 1),
                            BlockStateProvider.simple(ModBlocks.UME_LEAVES.get()),
                            new FancyFoliagePlacer(
                                    UniformInt.of(2, 3),
                                    UniformInt.of(1, 2),
                                    3),
