package com.chika.cpm.world.feature.tree;
...
public class FragrantOliveTreeGrower extends AbstractTreeGrower {


    @Nullable
    @Override
    protected Holder<? extends ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource p_222910_, boolean p_222911_) {
        return ModConfiguredFeatures.FRAGRANT_OLIVE.getHolder().get();
    }
}
