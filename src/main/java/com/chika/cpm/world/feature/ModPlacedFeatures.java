...
public class ModPlacedFeatures {
    ...
    //茶の木
    public static final RegistryObject<PlacedFeature>TEA_TREE_PLACED = PLACED_FEATURES.register("tea_tree_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.TEA_TREE_PATCH.getHolder()
                    .orElseThrow(() -> new IllegalStateException("TEA_TREE_PATCH not registered")),
