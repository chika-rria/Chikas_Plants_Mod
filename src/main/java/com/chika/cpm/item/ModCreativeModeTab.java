    ...
    public static final CreativeModeTab CPM_TAB = new CreativeModeTab("cpmtab") {
        ...
        public void fillItemList(NonNullList<ItemStack> items) {
            ...
            if (flowerIndex >= 0) {
                ...
                items.add(flowerIndex + 7, new ItemStack(ModBlocks.PLANTER_OAK.get()));
                items.add(flowerIndex + 8, new ItemStack(ModBlocks.PLANTER_SPRUCE.get()));
                items.add(flowerIndex + 9, new ItemStack(ModBlocks.PLANTER_BIRCH.get()));
                items.add(flowerIndex + 10, new ItemStack(ModBlocks.PLANTER_JUNGLE.get()));
                items.add(flowerIndex + 11, new ItemStack(ModBlocks.PLANTER_ACACIA.get()));
                items.add(flowerIndex + 12, new ItemStack(ModBlocks.PLANTER_DARK_OAK.get()));
                items.add(flowerIndex + 13, new ItemStack(ModBlocks.PLANTER_MANGROVE.get()));
                items.add(flowerIndex + 14, new ItemStack(ModBlocks.PLANTER_WARPED.get()));
                items.add(flowerIndex + 15, new ItemStack(ModBlocks.PLANTER_CRIMSON.get()));
                items.add(flowerIndex + 16, new ItemStack(ModBlocks.PLANTER_OAK_WOOD.get()));
                items.add(flowerIndex + 17, new ItemStack(ModBlocks.PLANTER_SPRUCE_WOOD.get()));
                items.add(flowerIndex + 18, new ItemStack(ModBlocks.PLANTER_BIRCH_WOOD.get()));
                items.add(flowerIndex + 19, new ItemStack(ModBlocks.PLANTER_JUNGLE_WOOD.get()));
                items.add(flowerIndex + 20, new ItemStack(ModBlocks.PLANTER_ACACIA_WOOD.get()));
                items.add(flowerIndex + 21, new ItemStack(ModBlocks.PLANTER_DARK_OAK_WOOD.get()));
                items.add(flowerIndex + 22, new ItemStack(ModBlocks.PLANTER_MANGROVE_WOOD.get()));
                items.add(flowerIndex + 23, new ItemStack(ModBlocks.PLANTER_WARPED_WOOD.get()));
                items.add(flowerIndex + 24, new ItemStack(ModBlocks.PLANTER_CRIMSON_WOOD.get()));
            } else {
                // 見つからなければ最後に置く
