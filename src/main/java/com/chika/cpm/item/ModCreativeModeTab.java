...
public class ModCreativeModeTab {
    ...
    public static final CreativeModeTab CPM_TAB2 = new CreativeModeTab("cpmtab2") {
        ...
        public void fillItemList(NonNullList<ItemStack> items) {
            ...
            items.removeIf(stack -> stack.is(ModBlocks.LARGE_POT_HERRINGBONE_OAK.get().asItem()));
            items.removeIf(stack -> stack.is(ModBlocks.LARGE_POT_HERRINGBONE_DARK_OAK.get().asItem()));
            ...
            if (flowerIndex >= 0) {
                List<ItemStack> flowerItems = List.of( // 花の次に置く
                        ...
                        new ItemStack(ModBlocks.LARGE_POT_HERRINGBONE_OAK.get()),
                        new ItemStack(ModBlocks.LARGE_POT_HERRINGBONE_DARK_OAK.get()),
                ...
                items.add(new ItemStack(ModBlocks.LARGE_POT_HERRINGBONE_OAK.get()));
                items.add(new ItemStack(ModBlocks.LARGE_POT_HERRINGBONE_DARK_OAK.get()));
