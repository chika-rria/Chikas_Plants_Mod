...
public class HorseDungWoodenBucketItem extends BoneMealItem {
    public HorseDungWoodenBucketItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        if(Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("tooltip.cpm.horse_dung_wooden_bucket").withStyle(ChatFormatting.WHITE));
        } else {
            tooltip.add(Component.translatable("tooltip.cpm.details").withStyle(ChatFormatting.WHITE));
        }
    }
}
