    ...
    public static final RegistryObject<BlockEntityType<CPM_FlowerPotBlockEntity>> CPM_FLOWER_POT_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("cpm_flower_pot_block_entity",
                    () -> BlockEntityType.Builder.of(
                            ...
                            ModBlocks.RIBBON_POT_PINK.get(),
                            ModBlocks.RIBBON_POT_LIGHT_BLUE.get(),
                            ModBlocks.RIBBON_POT_LIME.get(),

                            ModBlocks.WOODEN_CRATE_PLANTER_OAK.get(),
                            ModBlocks.WOODEN_CRATE_PLANTER_DARK_OAK.get(),
                            ModBlocks.WOODEN_CRATE_PLANTER_MAGENTA.get(),
                            ModBlocks.WOODEN_CRATE_PLANTER_LIGHT_BLUE.get(),
                            ModBlocks.WOODEN_CRATE_PLANTER_LIME.get(),
                            ModBlocks.SQUARE_POT_GRAY.get(),
                            ModBlocks.SQUARE_POT_RED.get(),
                            ModBlocks.FLOWER_POT_CYAN.get(),
                            ModBlocks.FLOWER_POT_LIGHT_BLUE.get(),
                            ModBlocks.FLOWER_POT_GLASS.get(),
                            ModBlocks.CUP_POT_RED.get(),
                            ModBlocks.CUP_POT_ORANGE.get(),
                            ModBlocks.CUP_POT_PURPLE.get(),
                            ModBlocks.CUP_POT_LIGHT_GRAY.get(),
                            ModBlocks.FLOWER_POT_MOSS_BALL.get(),
                            ModBlocks.DEEP_POT_GREEN.get(),
                            ModBlocks.DEEP_POT_PINK.get(),
                            ModBlocks.DEEP_POT_PURPLE.get(),
                            ModBlocks.DEEP_POT_YELLOW.get(),
                            ModBlocks.WATERING_CAN_PLANTER_IRON.get(),
                            ModBlocks.WATERING_CAN_PLANTER_COPPER.get(),
                            ModBlocks.WATERING_CAN_PLANTER_WEATHERED_COPPER.get(),
                            ModBlocks.MEDIUM_POT_BLUE.get(),
                            ...
                            ModBlocks.WATER_LILY_BOWL_BLUE.get(),
                            ModBlocks.WATER_LILY_BOWL_GREEN.get()
    ...
    public static final RegistryObject<BlockEntityType<CPM_ArrangementPotBlockEntity>> CPM_ARRANGEMENT_POT_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("cpm_arrangement_pot_block_entity",
                    () -> BlockEntityType.Builder.of(
                            ...
                            ModBlocks.LARGE_POT_BLUE.get(),
                            ModBlocks.LARGE_POT_ORANGE.get(),
                            ModBlocks.LARGE_POT_LIME.get(),
                            ModBlocks.LARGE_POT_HERRINGBONE_OAK.get(),
                            ModBlocks.LARGE_POT_HERRINGBONE_DARK_OAK.get(),
                            ModBlocks.FLOWER_BED_DIRT.get(),
                            ModBlocks.FLOWER_BED_GRASS.get(),
                            ModBlocks.FLOWER_BED_PODZOL.get(),
                            ModBlocks.FLOWER_BED_SAND.get(),
                            ModBlocks.FLOWER_BED_DIRT_HALF.get(),
                            ModBlocks.FLOWER_BED_GRASS_HALF.get(),
                            ModBlocks.FLOWER_BED_PODZOL_HALF.get(),
                            ModBlocks.FLOWER_BED_SAND_HALF.get()
    ...
    public static final RegistryObject<BlockEntityType<CPM_WoodPlanterBlockEntity>> CPM_WOOD_PLANTER_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("cpm_wood_planter_block_entity",
                    () -> BlockEntityType.Builder.of(
                            ...
                            ModBlocks.PLANTER_CHESTNUT.get(),
                            ModBlocks.PLANTER_PAULOWNIA.get(),
                            ModBlocks.PLANTER_UME.get(),
                            ...
                            ModBlocks.PLANTER_CHESTNUT_WOOD.get(),
                            ModBlocks.PLANTER_PAULOWNIA_WOOD.get(),
                            ModBlocks.PLANTER_UME_WOOD.get()
    ...
    public static final RegistryObject<BlockEntityType<ModSignBlockEntity>> SIGN_BLOCK_ENTITIES =
            BLOCK_ENTITIES.register("sign_block_entities", () ->
                    BlockEntityType.Builder.of(ModSignBlockEntity::new,
                            ...
                            ModBlocks.PAULOWNIA_WALL_SIGN.get(),
                            ModBlocks.PAULOWNIA_SIGN.get(),
                            ModBlocks.UME_WALL_SIGN.get(),
                            ModBlocks.UME_SIGN.get()).build(null));
